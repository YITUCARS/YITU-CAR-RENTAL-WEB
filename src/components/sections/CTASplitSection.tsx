  ...
  return (
    <section className="px-10 pb-20">
      <div className="max-w-[1100px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-4">
        {/* Big card */}
        <div
          className="relative rounded-card overflow-hidden min-h-[280px] flex flex-col justify-end p-8 cursor-pointer group"
          onClick={goToBooking}
        >
          ...
          <div className="relative z-10">
            <h3 className="font-syne font-extrabold text-[1.4rem] text-white leading-[1.2] mb-2.5">
        ...
        <div className="grid grid-rows-[1fr_auto] gap-4">
          ...
          >
            ...
            <div className="relative z-10 flex items-end justify-between gap-4">
              ...
              <strong className="font-syne font-extrabold text-[2.1rem] text-orange leading-none">100+</strong>
            </div>
          </div>
        </div>
      </div>
